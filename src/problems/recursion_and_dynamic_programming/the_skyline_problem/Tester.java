...
public class Tester {
    ...
    private void runTest(int[][] buildings, int[][] expected){
        List<List<Integer>> res = this._s.getSkyline(buildings);
    ...
    public void test1(){
        ...
        int[][] expectedRes = {{2, 10},{3, 15},{7, 12},{12, 0},{15, 10},{20, 8},{24, 0}};
        runTest(buildings, expectedRes);
    }

    @Test
    public void test2(){
        int[][] buildings = {{0,2,3},{2,5,3}};
        int[][] expectedRes = {{0,3},{5,0}};
        runTest(buildings, expectedRes);
    }
    ...
    public void test4(){
        ...
        int[][] expectedRes = {{1,219},{2,228},{19,225},{45,229},{89,190},{95,175},{97,152},{99,74},{100,0}};
        runTest(buildings, expectedRes);
    }
